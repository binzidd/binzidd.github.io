...
export const RACES_2026: Race2026[] = [
  ...
  },
  {
    ...
    engineNote: "Russell's PU failure on lap 30 is a reminder that even the class-leading Mercedes power unit carries reliability risk at high-output circuits. Ford-RBPT finally delivers a clean race, and Verstappen takes the podium.",
  },
];
...
export const ENGINE_CHANGES = {
  ...
  changes: [
    ...
    },
    {
      ...
      v2026: { label: "avg ~326 km/h", value: 326, color: "#27F4D2", detail: "Peak: 334 km/h at Montreal (Hamilton), with heavier cars and an active aero trade-off" },
    },
    {
